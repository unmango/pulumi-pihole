...
namespace UnMango.Pulumi.Pihole
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/unmango/pulumi-pihole";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.Pulumi.Pihole.version.txt");
    ...
    internal sealed class PiholeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PiholeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
