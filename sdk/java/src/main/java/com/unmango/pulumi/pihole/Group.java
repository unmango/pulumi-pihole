...
import com.unmango.pulumi.pihole.GroupArgs;
import com.unmango.pulumi.pihole.Utilities;
import com.unmango.pulumi.pihole.inputs.GroupState;
 ...
 * 
 */
@ResourceType(type="pihole:index/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(String name, @Nullable GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pihole:index/group:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Group(String name, Output<String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pihole:index/group:Group", name, state, makeResourceOptions(options, id));
    }
