...
def get_groups(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupsResult:
    ...
    __ret__ = pulumi.runtime.invoke('pihole:index/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult).value
...
def get_groups_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGroupsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('pihole:index/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
